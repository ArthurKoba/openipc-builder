...
# Majestic currently performs the required GPIO setup too, but keep the
# board pinmux explicit so the daylight input remains valid with another
# runtime/streamer that does not initialise this pad itself.
#
