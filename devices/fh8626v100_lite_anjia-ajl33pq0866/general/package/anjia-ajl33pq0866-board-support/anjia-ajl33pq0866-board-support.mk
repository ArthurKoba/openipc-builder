...
ANJIA_AJL33PQ0866_BOARD_SUPPORT_TARGETS = fh8626-lens
ifeq ($(BR2_PACKAGE_ANJIA_AJL33PQ0866_PTZ),y)
ANJIA_AJL33PQ0866_BOARD_SUPPORT_TARGETS += fh8626-ptz
endif

define ANJIA_AJL33PQ0866_BOARD_SUPPORT_BUILD_CMDS
	$(MAKE) CC="$(TARGET_CC)" CFLAGS="$(TARGET_CFLAGS)" \
		LDFLAGS="$(TARGET_LDFLAGS)" -C $(@D) \
		$(ANJIA_AJL33PQ0866_BOARD_SUPPORT_TARGETS)
endef
...
define ANJIA_AJL33PQ0866_BOARD_SUPPORT_INSTALL_TARGET_CMDS
	...
	$(if $(BR2_PACKAGE_ANJIA_AJL33PQ0866_PTZ), \
		$(INSTALL) -D -m 0755 $(@D)/fh8626-ptz $(TARGET_DIR)/usr/sbin/fh8626-ptz; \
		cp -a $(ANJIA_AJL33PQ0866_BOARD_SUPPORT_PKGDIR)/ptz-files/. $(TARGET_DIR)/;)
